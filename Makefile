...
## /c :: compile only
CFLAGS = /nologo /MT /W3 /EHsc /Ox /O2 /I "." /D "WIN32" /D "NDEBUG" /D "_CRT_SECURE_NO_WARNINGS" /wd4996 /WX /c
...
#CFLAGS = /nologo /MTd /W3 /EHsc /Od /Gm /Zi /I "." /D "WIN32" /D "DEBUG" /D "_CONSOLE" /c
