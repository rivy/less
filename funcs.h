...
public void lesskey_parse_error (char *msg);
...
public void opt_rstat (int type, char *s);
...
public void xbuf_add (struct xbuffer *xbuf, int ch);
public void xbuf_add_data(struct xbuffer *xbuf, unsigned char *data, int len);
public int xbuf_pop (struct xbuffer *xbuf);
