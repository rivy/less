...
public int utf_len LESSPARAMS ((PARAM_unsigned_char ch));
...
public int pappend LESSPARAMS ((PARAM_unsigned_char, POSITION pos));
public int pflushmbc LESSPARAMS ((VOID_PARAM));
public void pdone LESSPARAMS ((int endline, int chopped, int forw));
public void set_status_col LESSPARAMS ((PARAM_char c));
